"""
Database layer for Arabic kalimle app.
Uses the shared database module with Arabic-specific configuration.
"""
import sys
import os
...
from arabic.language_config import FALLBACK_PUZZLES
