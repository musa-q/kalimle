"""
kelimle - Turkish Wordle FastAPI Application
...
from turkish.language_config import validator, LANGUAGE_CONFIG, KEYBOARD_LAYOUT
from turkish.config import get_settings
import turkish.database as database


app = FastAPI(title="kelimle", description="Daily Turkish Word Puzzle Game")
